...
# Using save method
df.coalesce(1).write.format("parquet").mode("overwrite").save("abfss://data@dbstoragezat11.dfs.core.windows.net/parquet/countries_parquet")

# COMMAND ----------

# Escritura de DataFrame en formato Delta Lake
# Delta Lake solo admite el método de guardado
df.write.format("delta").save("abfss://data@dbstoragezat11.dfs.core.windows.net/delta/countries_parquet")

# COMMAND ----------

# Lectura y visualización de archivos de Parquet y Delta Lake
spark.read.format("parquet").load("abfss://data@dbstoragezat11.dfs.core.windows.net/parquet/countries_parquet").display()
spark.read.format("delta").load("abfss://data@dbstoragezat11.dfs.core.windows.net/delta/countries_parquet").display()