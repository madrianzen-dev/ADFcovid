...
df.write.csv("abfss://data@dbstoragezat11.dfs.core.windows.net/csv/countries_hrc_csv",mode="overwrite")
...
display(dbutils.fs.ls("abfss://data@dbstoragezat11.dfs.core.windows.net/csv/countries_hrc_csv"))
...
df.write.mode("overwrite").csv("abfss://data@dbstoragezat11.dfs.core.windows.net/csv/countries_hrc_csv")
...
df.coalesce(1).write.format("csv").mode("overwrite").save("abfss://data@dbstoragezat11.dfs.core.windows.net/csv/countries_hrc_csv2")
...
df.write.format("csv") \
    ...
    .mode("overwrite") \
    .save("abfss://data@dbstoragezat11.dfs.core.windows.net/csv/countries_hrc_csv_4")
