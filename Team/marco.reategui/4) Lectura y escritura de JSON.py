...
df.coalesce(1).write.json("abfss://data@dbstoragezat11.dfs.core.windows.net/json/countries_json_mrch",mode="overwrite")

# COMMAND ----------

# Displaying the directory contents
display(dbutils.fs.ls("abfss://data@dbstoragezat11.dfs.core.windows.net/json/countries_json_mrch"))

# COMMAND ----------

# Previewing the raw contents of a partitioned JSON file
print(dbutils.fs.head("abfss://data@dbstoragezat11.dfs.core.windows.net/json/countries_json_mrch/part-00000-tid-3777421691993667799-f379ab8d-9d9f-48e4-a4c4-20184f501919-36-1-c000.json"))
...
spark.read.json("abfss://data@dbstoragezat11.dfs.core.windows.net/json/countries_json_mrch").display()
