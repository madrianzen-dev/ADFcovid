...
folder="abfss://rawprz@dbstoragezat11.dfs.core.windows.net/poblacion/datospoblacion/"
...
#df_raw_pob_x_edad_pivot.display()
df_raw_pob_x_edad_pivot.createOrReplaceTempView("raw_pob_x_edad_pivot")

# COMMAND ----------

spark = SparkSession.builder.getOrCreate()
folder="abfss://rawprz@dbstoragezat11.dfs.core.windows.net/procesado/"
files = dbutils.fs.ls(folder)
print(files)
