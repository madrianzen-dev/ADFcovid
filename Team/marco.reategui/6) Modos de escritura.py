...
df = spark.read.format("parquet").load("abfss://data@dbstoragezat11.dfs.core.windows.net/parquet/countries_parquet_mrch")
...
df.write.mode("overwrite").format("parquet").save("abfss://data@dbstoragezat11.dfs.core.windows.net/parquet/countries_parquet_mrch")
#df = spark.read.format("parquet").load("abfss://data@dbstoragezat11.dfs.core.windows.net/parquet/countries_parquet_mrch")
df.count()
...
df.write.mode("append").format("parquet").save("abfss://data@dbstoragezat11.dfs.core.windows.net/parquet/countries_parquet_mrch")
df = spark.read.format("parquet").load("abfss://data@dbstoragezat11.dfs.core.windows.net/parquet/countries_parquet_mrch")
df.count()