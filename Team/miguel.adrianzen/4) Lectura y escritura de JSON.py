...
df.coalesce(1).write.json("abfss://data@dbstoragezat11.dfs.core.windows.net/json/countries_json",mode="overwrite")

# COMMAND ----------

# Displaying the directory contents
display(dbutils.fs.ls("abfss://data@dbstoragezat11.dfs.core.windows.net/json/countries_json"))

# COMMAND ----------

# Previewing the raw contents of a partitioned JSON file
print(dbutils.fs.head("abfss://data@dbstoragezat11.dfs.core.windows.net/json/countries_json/part-00000-tid-2619002259353422020-19861323-f874-420c-bb02-e76611a49f3c-37-1-c000.json"))
...
spark.read.json("abfss://data@dbstoragezat11.dfs.core.windows.net/json/countries_json").display()
