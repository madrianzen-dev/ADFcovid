...
df_clientes.write.format("delta").mode("overwrite").save("zatdev11db.bronze.CL_EMPLEADOS_tb_hrc")

# COMMAND ----------

# MAGIC %sql
# MAGIC create or replace table zatdev11db.silver.customers_tb_hrc (
...
# MAGIC )
# MAGIC  USING DELTA
# MAGIC  LOCATION 'abfss://data@dbstoragezat11.dfs.core.windows.net/silver/customers_tb_hrc';
...
df_clientes_bronze = df_clientes.withColumn("bronze_load_ts", current_timestamp())
df_clientes_bronze.display()
df_clientes_bronze.write.format("delta").mode("overwrite").saveAsTable("zatdev111db.bronze.customers_hrc")