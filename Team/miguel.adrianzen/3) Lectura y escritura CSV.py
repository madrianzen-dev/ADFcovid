...
display(dbutils.fs.ls("abfss://data@dbstoragezat11.dfs.core.windows.net/csv/countries_csv"))
...
print(dbutils.fs.head('abfss://data@dbstoragezat11.dfs.core.windows.net/csv/countries_csv/part-00000-tid-712763749434936722-6b46cfe2-e5ee-416c-8fdc-c8d7f1fe9abd-0-1-c000.csv', 10000))
...
df.write.mode("overwrite").csv("abfss://inputs@dbstoragezat10.dfs.core.windows.net/exportcsv/countries_csv")
...
df.coalesce(1).write.format("csv").mode("overwrite").save("abfss://data@dbstoragezat11.dfs.core.windows.net/csv/countries_csv2")
...
display(dbutils.fs.ls("abfss://data@dbstoragezat11.dfs.core.windows.net/csv/countries_csv3"))
...
print(dbutils.fs.head('abfss://data@dbstoragezat11.dfs.core.windows.net/csv/countries_csv3/part-00000-tid-2655159081408103319-8ca876d2-795b-48d7-81c6-ab13c90f6fdf-4-1-c000.csv', 10000))
...
df_read_default = spark.read.csv("abfss://data@dbstoragezat11.dfs.core.windows.net/csv/countries_csv3")
...
df_read = spark.read.csv("abfss://data@dbstoragezat11.dfs.core.windows.net/csv/countries_csv3", sep="[", header=True)
df_read.display()
...
df_read = spark.read.options(sep="[", header=True).csv("abfss://data@dbstoragezat11.dfs.core.windows.net/csv/countries_csv3")
df_read.display()
...
df_inferred = spark.read.options(sep="[", header=True, inferSchema=True).csv("abfss://data@dbstoragezat11.dfs.core.windows.net/csv/countries_csv3")
...
df_explicit = spark.read.options(sep=";", header=True, inferSchema=True) \
    ...
    .csv("abfss://data@dbstoragezat11.dfs.core.windows.net/csv/countries_csv3", sep=";")
