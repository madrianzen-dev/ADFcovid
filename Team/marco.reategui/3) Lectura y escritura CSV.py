...
df.write.csv("abfss://data@dbstoragezat11.dfs.core.windows.net/csv/countries_csv_mrch",mode="overwrite")
...
display(dbutils.fs.ls("abfss://data@dbstoragezat11.dfs.core.windows.net/csv/countries_csv_mrch"))
...
print(dbutils.fs.head('abfss://data@dbstoragezat11.dfs.core.windows.net/csv/countries_csv_mrch/part-00000-tid-3038478826481428776-672faebd-1023-4981-bdae-9faf748c16b0-81-1-c000.csv', 10000))
...
#df.write.csv("dbfs:/FileStore/write_demo/countries_csv")
df.write.csv("abfss://data@dbstoragezat11.dfs.core.windows.net/csv/countries_csv_mrch_v1",mode="overwrite")
...
df.write.mode("overwrite").csv("abfss://data@dbstoragezat11.dfs.core.windows.net/exportcsv/countries_csv2")
