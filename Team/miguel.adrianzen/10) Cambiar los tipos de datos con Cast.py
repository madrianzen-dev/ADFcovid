...
# MAGIC %md
# MAGIC ## Cambio de tipos de datos con Cast
# MAGIC El método `cast()` en PySpark se utiliza para cambiar el tipo de datos de una columna en un DataFrame.
# MAGIC
# MAGIC Se puede aplicar dentro de `withColumn()` o `select()` para convertir valores a un tipo de datos específico.

# COMMAND ----------

# MAGIC %md
# MAGIC ### Links and Resources
# MAGIC - [cast()](https://spark.apache.org/docs/latest/api/python/reference/pyspark.sql/api/pyspark.sql.Column.cast.html#pyspark.sql.Column.cast)
# MAGIC - [Data Types](https://spark.apache.org/docs/3.5.3/sql-ref-datatypes.html)
...
# MAGIC %md
# MAGIC ### Using cast() in withColumn
